  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <div
        ...
        className={`cursor-pointer bg-[#83bff6] flex flex-col items-center justify-center p-6 rounded-lg shadow-md mt-8 gap-2 hover:shadow-lg hover:bg-[#6aaceb] transition-all ${
